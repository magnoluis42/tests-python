...
navegador.find_element('xpath', '/html/body/table[2]/tbody/tr/td[2]/div/table/tbody/tr[9]/td[3]/input[1]').send_keys("senha10")
navegador.find_element('xpath', '/html/body/table[2]/tbody/tr/td[2]/div/table/tbody/tr[9]/td[3]/input[2]').send_keys("senha10")
navegador.find_element('xpath', '/html/body/table[2]/tbody/tr/td[2]/div/table/tbody/tr[9]/td[4]/input').click()

navegador.find_element('xpath', '//*[@id="LoginLink"]/font').click()
navegador.find_element('xpath', '//*[@id="LoginLink"]/font').click()
navegador.find_element('xpath', '//*[@id="uid"]').send_keys("magnoluis")
navegador.find_element('xpath', '//*[@id="passw"]').send_keys("senha10")
navegador.find_element('xpath', '//*[@id="login"]/table/tbody/tr[3]/td[2]/input').click()


#navegador.find_element('xpath', '').click()
#navegador.find_element('xpath', '').send_keys()
